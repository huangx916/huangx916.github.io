...
C#多维数组: int[,] a = new int[5, 2] {{0,0}, {1,2}, {2,4}, {3,6}, {4,8} };	int n = a[0,0];  
C#交错数组: int[][] scores = new int[2][]{new int[]{92,93,94},new int[]{85,66,87,88}};	// 其中，scores 是一个由两个整型数组组成的数组 -- scores[0] 是一个带有 3 个整数的数组，scores[1] 是一个带有 4 个整数的数组。  
