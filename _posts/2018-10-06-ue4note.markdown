...
###### 生成：  
* Class: GENERATED_BODY |	Hello_Source_Hello_MyClass_h_11_GENERATED_BODY |    Hello_Source_Hello_MyClass_h_11_ENHANCED_CONSTRUCTORS |	static TClassCompiledInDefer<UMyClass> AutoInitializeUMyClass(TEXT("UMyClass"), sizeof(UMyClass), 899540749);  
